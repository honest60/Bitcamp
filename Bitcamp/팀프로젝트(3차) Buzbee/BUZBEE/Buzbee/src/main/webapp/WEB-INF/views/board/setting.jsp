...
<title>${loginDTO.m_name}(@${loginDTO.username})님 | 버즈비 </title>
...
<body>
      ...
      <div class="main-bar">
            ...
            <div class="hidden-profile">
               ...
               <div>
                  <div class="hidden-text">
                     <a href="<c:url value='/${loginDTO.username}'/>" class="text-head">${loginDTO.m_name}</a>               
                  </div>                        
                  <div class="hidden-text">
                     <a href="" class="text-tail">@${loginDTO.username}</a>                           
                  </div>
               </div>                     
            </div>            
         </div>
         <div class="second-menu">   
            <ul>
               <li class="second-li">
                  <a href="<c:url value='/${member.m_id}'/>">
                  <span class="menu-title">버짓스</span>   
               ...
               <li>
                  <a href="#">              
                  <span class="menu-title">버저스</span>
   ...
   <div class="body  origin" id="body-md">
     <div class="sidebar-padding" id="sidebar-md">
        <div class="profile-location">
         <div class="profile-size">
            <p>              
             <img src="${pageContext.request.contextPath}/img/${profile}" class="profile-img img-circle">              
            </p>
            <div class="introduce">
     ...
     <section id="main-content">
        ...
        <div id='content-area' style='margin-left:200px;border:1px solid #ffe180;border-radius:8px;margin-right:50px'>
			<form id="myForm" action="setting-confirm" encType='multipart/form-data' method='post'>
			  <h1 style='margin-bottom:0'>프로필 사진 수정</h1>
			  <input type='file' name='profileImg' style='margin:auto;font-size:1.4rem;width:auto' onchange='preview(this, ".profile-img")'/>
			  <h1 style='margin-bottom:0'>헤더 사진 수정</h1>
			  <input type='file' name='headerImg' style='margin:auto;font-size:1.4rem;width:auto' onchange='preview(this, ".main-img")'/>
			  
			  <h1>아이디 변경</h1>
			  <div class="float-label">
			    <input type="text" name="m_id" id="m_id" />
			    <label for="f-name">아이디 수정 (5자 이상)</label>
		    	<span id='id-check' style='font-size:1.6rem;color:red'></span>
			  </div>
			  ...
			  <div class="float-label">
			    <textarea name="m_content" id="m_content"></textarea>
			    <label for="notes">자기소개</label>
			  </div>
			  <button class="settingbtn" type="submit">수정</button>
			  <button class="settingbtn" id="clear" type="reset" value="Reset">다시 쓰기</button>
			</form>
         </div>
         </section>
      </section>
...
<script src="${pageContext.request.contextPath}/lib/setting.js"></script>
