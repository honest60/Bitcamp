		 ...
		 var htmlNew = '<div id="newBuzzing" onclick="showNewBuzzing()" style="display:none">새로운 버징 '+ newBuzzingCount +'개 보기</div>';
  		 var html = '<div class="media lists new" id="lists'+boardNo+'" style="display:none">'+
				       '<a class="media-left" href="#fake">'+
				           '<img alt="" class="content-profile media-object img-circle" src="resources/img/'+profile+'">'+
				       '</a>'+
...
<body>
	...
	<!--  버즈비 로고 -->
	  ...
	  <div class="collapse navbar-collapse container" id='header-notice'>
	    ...
	    <ul class="navbar-nav mr-auto" id='menus'>
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="board/notice"><i class="octicon octicon-bell"></i>  알림</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="board/setting"><i class="glyphicon glyphicon-cog"></i> 설정</a>
	      </li>
	    </ul>
     ...
     <aside>
      <div id="sidebar" class="nav-collapse" tabindex='1'>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="${loginDTO.username}"><img src="resources/img/${profile}" alt='프사없음' class="img-circle" width='180' height='180'></a></p>
      ...
      <div class="col-lg-9" id='timeline'>
         <div class="panel panel-info" id='content-border'>
            <div class="panel-heading" id='input-form'>
               <a class="media-left" href="#fake">
                  <img id='buz-img' alt="" class="media-object img-circle" src="resources/img/${profile}">
               </a>
               <div class="media-body">
                  <div class="form-group has-feedback" id='inputarea'>
                     ...
                     <div class="img-area-main" style='display:flex;background-color:#fff3e6;margin-top:5px'></div>
                  </div>
               </div>
            </div>
            ...
            <c:forEach items='${buzzing}' var='buzz'>
               <div class="media lists" id='lists${buzz.b_no}'>
                  <a class="media-left" href="${buzz.m_id}">
                     <img alt="profile-image" class="content-profile media-object img-circle" src="resources/img/${buzz.img_profile}">
                  </a>
	...
	<div class="modal fade" id="content-modal"  data-toggle='modal'>
      ...
      <div class='modal-area'>
	      ...
	      <div class="twitter-card-icons">
	          ...
	          <li class="navi_set glyphicon glyphicon-option-horizontal topnav dropmodal" onclick="dropMenu()">  
			     <ul class="subnav listmodal" id='subnav'>
			     </ul>  
		      </li>
	      </div>
	      </div>
            ...
            <c:forEach items='${recommend}' var='member'>
               <div class="media recommend-body" id='recommend${member.m_no}'>
                  <div class="media-left">
                     <img src="resources/img/${member.profile_name}" alt="" class="media-object img-circle recommend">
                  </div>
                  <div class="media-body">
  ...
  <script src="lib/hyeong.js"></script>
</body>
