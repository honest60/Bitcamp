			...
			<div id="slideMenu">
				<div class="slideHeader">
					<a href="<c:url value='/${loginDTO.username}'/>">
						<img src="${pageContext.request.contextPath}/img/${profile}" class="slide-img">   
			 ...
			 <div id="col-sm-content" class="timeline">	
				<div>				
					...
					<c:if test="${empty buzzing}">
						<div id='empty-buzzing'>아직 좋아한 버징이 없습니다. 좋아요를 눌러주세요!</div>
					</c:if>
					<c:forEach items="${buzzing}" var="buzz">
					<c:if test='${buzz.m_id == loginDTO.username}'>
					   <div class="content">
						  <a href="#fake">
							 <img alt="" class="content-img" src="${pageContext.request.contextPath}/img/${profile}">
						  </a>
            ...
            <c:forEach items='${recommend}' var='member'>
               <div class="media recommend-body" id='recommend${member.m_no}'>
                  <div class="media-left">
                     <img src="${pageContext.request.contextPath}/img/${member.profile_name}" alt="" class="media-object recommend-profile recommend">
                  </div>
