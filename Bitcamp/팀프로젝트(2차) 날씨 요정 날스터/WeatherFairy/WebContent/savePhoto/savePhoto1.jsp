					...
					<div class="container">
						<div class="row">							
							...
							<div class="breadcrumb">							
                                ...
                                &nbsp;&nbsp;&nbsp;직접입력
                                <input type="text" name="up" value=""><br>
                                <div class="widget"><br>
									하의
								</div>                                
                                ...
                                &nbsp;&nbsp;&nbsp;직접입력
                                <input type="text" name="outer" value=""><br>
                                <div class="widget"><br>
									ETC
								</div>                                
                                ...
                                &nbsp;&nbsp;&nbsp;직접입력
                                <input type="text" name="etc" value=""><br>
                                <div class="widget"><br>
									[ 오늘의 코디를 남겨주세요!! ] (중복선택가능)
								</div>
                                ...
                                &nbsp;&nbsp;&nbsp;직접입력
                                <input type="text" name="feeling" value=""><br>
                                <tr>
